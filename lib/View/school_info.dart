...
class SchoolInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var schoolViewModel = Provider.of<SchoolViewModel>(context);
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 120,
                      ...
                      child: TextButton(
                        onPressed: () {
                          ...
                          // TODO: Hint: Replace the class attributes with the data fetched from the JSON file
                            schoolViewModel.fetchSchool().then((value) {
                              schoolName = schoolViewModel.school.schoolName!;
                              schoolAddress = schoolViewModel.school.schoolAddress!;
                              studentsNo= schoolViewModel.school.numberOfStudents!;
                              teachersNo= schoolViewModel.school.numberOfTeachers!;
                            });
                        },
                        child: const Text(
                          'Show Data',
